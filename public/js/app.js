...
var MAXIMOS_INTENTOS = 8,
  // Intentos máximos que tiene el jugador
  COLUMNAS = 4,
  // Columnas del memorama
  SEGUNDOS_ESPERA_VOLTEAR_IMAGEN = 1,
  // Por cuántos segundos mostrar ambas imágenes
...
new Vue({
  ...
  data: function data() {
    return {
      ...
      imagenes: ["./img/bici.jpg", "./img/stop.jpg", "./img/crucepeaton.png", "./img/escolar.png", "./img/Semaforo.png", "./img/señal6.png"],
      memorama: [],
  ...
  methods: {
    ...
    indicarFracaso: function indicarFracaso() {
      Swal.fire({
        title: "Perdiste",
    ...
    indicarVictoria: function indicarVictoria() {
      Swal.fire({
        title: "¡Ganaste!",
    ...
    haGanado: function haGanado() {
      return this.memorama.every(function (arreglo) {
        return arreglo.every(function (imagen) {
          return imagen.acertada;
        });
      });
    },
    // Ayudante para mezclar un arreglo
    mezclarArreglo: function mezclarArreglo(a) {
      var j, x, i;
    ...
    aumentarIntento: function aumentarIntento() {
      this.intentos++;
    ...
    voltear: function voltear(indiceFila, indiceImagen) {
      var _this = this;
      ...
      var imagenSeleccionada = this.memorama[indiceFila][indiceImagen];
      var ultimaImagenSeleccionada = this.memorama[this.ultimasCoordenadas.indiceFila][this.ultimasCoordenadas.indiceImagen];
      ...
      if (imagenSeleccionada.ruta === ultimaImagenSeleccionada.ruta) {
        ...
        setTimeout(function () {
          _this.memorama[indiceFila][indiceImagen].mostrar = false;
          _this.memorama[indiceFila][indiceImagen].animacion = false;
          _this.memorama[_this.ultimasCoordenadas.indiceFila][_this.ultimasCoordenadas.indiceImagen].mostrar = false;
          _this.ultimasCoordenadas.indiceFila = null;
          _this.ultimasCoordenadas.indiceImagen = null;
          _this.esperandoTimeout = false;
    ...
    reiniciarJuego: function reiniciarJuego() {
      var memorama = [];
      this.imagenes.forEach(function (imagen, indice) {
        var imagenDeMemorama = {
          ruta: imagen,
          mostrar: false,
          // No se muestra la original
      ...
      var memoramaDividido = [];
      for (var i = 0; i < memorama.length; i += COLUMNAS) {
    ...
    precargarImagenes: function precargarImagenes() {
      var _this2 = this;
      // Mostrar la alerta
      Swal.fire({
        title: "Cargando",
        html: "Cargando im\xE1genes...",
        allowOutsideClick: false,
        allowEscapeKey: false
      }).then(this.reiniciarJuego);
      ...
      var total = this.imagenes.length,
        contador = 0;
      var imagenesPrecarga = Array.from(this.imagenes);
      ...
      imagenesPrecarga.forEach(function (ruta) {
...
var correctas = [1, 1, 2, 2, 1];
var opcion_elegida = [];
var cantidad_correctas = 0;
console.log(opcion_elegida.length);
function respuesta(num_pregunta, seleccionada) {
  opcion_elegida[num_pregunta] = seleccionada.value;
  id = "p" + num_pregunta;
  labels = document.getElementById(id).childNodes;
  seleccionada.parentNode.style.backgroudColor = "#cec0fc";
  if (opcion_elegida.length == 5 && !opcion_elegida.includes(undefined)) {
    mostrarBoton();
  }
}
...
__webpack_require__(/*! ../../public/js/script1 */ "./public/js/script1.js");
